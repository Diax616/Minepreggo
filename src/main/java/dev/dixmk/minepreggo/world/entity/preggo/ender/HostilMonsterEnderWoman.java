...
public class HostilMonsterEnderWoman extends AbstractHostilEnderWoman {
	
	public HostilMonsterEnderWoman(PlayMessages.SpawnEntity packet, Level world) {
		this(MinepreggoModEntities.HOSTILE_MONSTER_ENDER_WOMAN.get(), world);
	}

	public HostilMonsterEnderWoman(EntityType<HostilMonsterEnderWoman> type, Level world) {
