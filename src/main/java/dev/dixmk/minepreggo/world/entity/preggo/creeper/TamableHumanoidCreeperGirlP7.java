...
public class TamableHumanoidCreeperGirlP7 extends AbstractTamablePregnantHumanoidCreeperGirl<PregnantPreggoMobSystemP2<TamableHumanoidCreeperGirlP7>,PreggoMobPregnancySystemP7<TamableHumanoidCreeperGirlP7>> implements IPregnancyP7<TamableHumanoidCreeperGirlP7> {
	...
	@Override
	protected PregnantPreggoMobSystemP2<TamableHumanoidCreeperGirlP7> createPreggoMobSystem() {
		return new PregnantPreggoMobSystemP2<>(this, MinepreggoModConfig.getTotalTicksOfHungryP7(), PregnancySystemHelper.TOTAL_TICKS_SEXUAL_APPETITE_P7);
	}
	
	@Override
	protected PreggoMobPregnancySystemP7<TamableHumanoidCreeperGirlP7> createPregnancySystem() {
	...
	@Override
	public PreggoMobPregnancySystemP7<TamableHumanoidCreeperGirlP7> getPregnancySystemP7() {
