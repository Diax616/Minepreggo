...
public abstract class AbstractHostilPregnantZombieGirl extends AbstractHostilZombieGirl implements IHostilPregnantPreggoMob {

	private static final HostilPregnantPreggoMobDataImpl.DataAccessor<AbstractHostilPregnantZombieGirl> DATA_ACCESOR = new HostilPregnantPreggoMobDataImpl.DataAccessor<>(AbstractHostilPregnantZombieGirl.class);
	private final IHostilPreggoMobPregnancyData pregnancyData;
	
	protected AbstractHostilPregnantZombieGirl(EntityType<? extends AbstractHostilZombieGirl> p_21803_, Level p_21804_, PregnancyPhase currentPregnancyStage) {
	...
	protected void registerGoals() {
		...
		}.setAlertOthers(AbstractHostilZombieGirl.class));	
