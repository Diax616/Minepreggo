...
public abstract class AbstractHostilZombieGirl extends AbstractZombieGirl implements IHostilPreggoMob {

	protected AbstractHostilZombieGirl(EntityType<? extends AbstractZombieGirl> p_21803_, Level p_21804_) {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(1, new HurtByTargetGoal(this).setAlertOthers(AbstractHostilZombieGirl.class));	
	...
	public static boolean checkSpawnRules(EntityType<? extends AbstractHostilZombieGirl> p_219014_, ServerLevelAccessor p_219015_, MobSpawnType p_219016_, BlockPos p_219017_, RandomSource p_219018_) {
