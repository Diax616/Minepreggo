...
public class MonsterCreeperHelper {
	...
	public static EntityType<? extends AbstractTamablePregnantMonsterCreeperGirl> getEntityType(PregnancyPhase phase) {	
		return switch (phase) {
			case P0 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P0.get();
			case P1 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P1.get();
			case P2 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P2.get();
			case P3 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P3.get();
			case P4 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P4.get();
			case P5 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P5.get();
			case P6 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P6.get();
			case P7 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P7.get();	
			case P8 -> MinepreggoEntities.TAMABLE_MONSTER_CREEPER_GIRL_P8.get();	
