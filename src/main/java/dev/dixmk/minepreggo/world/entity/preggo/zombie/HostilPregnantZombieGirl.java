...
public class HostilPregnantZombieGirl {

	public static boolean checkSpawnRules(EntityType<? extends AbstractHostilPregnantZombieGirl> p_219014_, ServerLevelAccessor p_219015_, MobSpawnType p_219016_, BlockPos p_219017_, RandomSource p_219018_) {
		return MinepreggoModConfig.SERVER.isSpawningHostilPregnantZombieGirlsEnable() && AbstractHostilZombieGirl.checkSpawnRules(p_219014_, p_219015_, p_219016_, p_219017_, p_219018_);
	}
	
	public static class MonsterZombieGirlP3 extends AbstractHostilPregnantZombieGirl {
	...
	public static class MonsterZombieGirlP5 extends AbstractHostilPregnantZombieGirl {
	...
	public static class MonsterZombieGirlP7 extends AbstractHostilPregnantZombieGirl {
