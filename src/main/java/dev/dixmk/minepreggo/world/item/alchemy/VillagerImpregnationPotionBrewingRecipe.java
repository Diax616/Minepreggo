...
public abstract class VillagerImpregnationPotionBrewingRecipe implements IBrewingRecipe {
	...
	public boolean isIngredient(ItemStack ingredient) {
		return ingredient.is(MinepreggoItems.VILLAGER_LIFE_SUBSTANCE.get());
	}
	...
	public static class Amplifier0 extends VillagerImpregnationPotionBrewingRecipe {		
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.VILLAGER_IMPREGNATION_0.get());
	...
	public static class Amplifier1 extends VillagerImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.VILLAGER_IMPREGNATION_1.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier2 extends VillagerImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.VILLAGER_IMPREGNATION_2.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier3 extends VillagerImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.VILLAGER_IMPREGNATION_3.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier4 extends VillagerImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.VILLAGER_IMPREGNATION_4.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
