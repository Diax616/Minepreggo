...
public abstract class ZombieImpregnationPotionBrewingRecipe implements IBrewingRecipe {
	...
	public boolean isIngredient(ItemStack ingredient) {
		return ingredient.is(MinepreggoItems.ZOMBIE_LIFE_SUBSTANCE.get());
	}
	...
	public static class Amplifier0 extends ZombieImpregnationPotionBrewingRecipe {		
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.ZOMBIE_IMPREGNATION_0.get());
	...
	public static class Amplifier1 extends ZombieImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.ZOMBIE_IMPREGNATION_1.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier2 extends ZombieImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.ZOMBIE_IMPREGNATION_2.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier3 extends ZombieImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.ZOMBIE_IMPREGNATION_3.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier4 extends ZombieImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoPotions.ZOMBIE_IMPREGNATION_4.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
