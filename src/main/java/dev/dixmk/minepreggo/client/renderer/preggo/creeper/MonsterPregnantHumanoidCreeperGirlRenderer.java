...
import dev.dixmk.minepreggo.client.model.entity.preggo.creeper.HostilPregnantHumanoidCreeperGirlModel;
...
public class MonsterPregnantHumanoidCreeperGirlRenderer {
	...
	@OnlyIn(Dist.CLIENT)
	public static class MonsterHumanoidCreeperGirlP3Renderer extends AbstractHostilPregnantHumanoidCreeperGirlRenderer<HostilPregnantHumanoidCreeperGirl.MonsterHumanoidCreeperGirlP3, HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP3Model> {
		...
		public MonsterHumanoidCreeperGirlP3Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter, ModelLayerLocation armor) {
			super(context, new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP3Model(context.bakeLayer(main)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP3Model(context.bakeLayer(inner)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP3Model(context.bakeLayer(outter)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP3Model(context.bakeLayer(armor)));
		}

		@Override
		public ResourceLocation getTextureLocation(HostilPregnantHumanoidCreeperGirl.MonsterHumanoidCreeperGirlP3 p_115812_) {
			return CREEPER_GIRL_P3_LOCATION;
		}
	}
	
	@OnlyIn(Dist.CLIENT)
	public static class MonsterHumanoidCreeperGirlP5Renderer extends AbstractHostilPregnantHumanoidCreeperGirlRenderer<HostilPregnantHumanoidCreeperGirl.MonsterHumanoidCreeperGirlP5, HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP5Model> {
		...
		public MonsterHumanoidCreeperGirlP5Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter, ModelLayerLocation armor) {
			super(context, new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP5Model(context.bakeLayer(main)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP5Model(context.bakeLayer(inner)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP5Model(context.bakeLayer(outter)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP5Model(context.bakeLayer(armor)));
		}

		@Override
		public ResourceLocation getTextureLocation(HostilPregnantHumanoidCreeperGirl.MonsterHumanoidCreeperGirlP5 p_115812_) {
			return AbstractHumanoidCreeperGirlRenderer.CREEPER_GIRL_P5_LOCATION.getLeft();
		}
	}
	
	@OnlyIn(Dist.CLIENT)
	public static class MonsterHumanoidCreeperGirlP7Renderer extends AbstractHostilPregnantHumanoidCreeperGirlRenderer<HostilPregnantHumanoidCreeperGirl.MonsterHumanoidCreeperGirlP7, HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP7Model> {
		...
		public MonsterHumanoidCreeperGirlP7Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter, ModelLayerLocation armor) {
			super(context, new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP7Model(context.bakeLayer(main)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP7Model(context.bakeLayer(inner)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP7Model(context.bakeLayer(outter)), new HostilPregnantHumanoidCreeperGirlModel.MonsterHumanoidCreeperGirlP7Model(context.bakeLayer(armor)));
		}
	
		@Override
		public ResourceLocation getTextureLocation(HostilPregnantHumanoidCreeperGirl.MonsterHumanoidCreeperGirlP7 p_115812_) {
