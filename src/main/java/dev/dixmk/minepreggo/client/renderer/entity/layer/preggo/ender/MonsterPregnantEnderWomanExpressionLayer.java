...
@OnlyIn(Dist.CLIENT)
public class MonsterPregnantEnderWomanExpressionLayer 
	<E extends AbstractTamablePregnantEnderWoman, M extends AbstractTamablePregnantMonsterEnderWomanModel<E>> extends MonsterEnderWomanExpressionLayer<E, M> {

	public MonsterPregnantEnderWomanExpressionLayer(RenderLayerParent<E, M> p_117346_) {
		super(p_117346_);
	}
