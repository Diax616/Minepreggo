...
@OnlyIn(Dist.CLIENT)
public class MonsterHumanoidPregnantCreeperGirlExpressionLayer 
	...
	public MonsterHumanoidPregnantCreeperGirlExpressionLayer(RenderLayerParent<E, M> p_117346_) {
		super(p_117346_);
	}
