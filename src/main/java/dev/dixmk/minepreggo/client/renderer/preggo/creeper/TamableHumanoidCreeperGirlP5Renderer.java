...
import dev.dixmk.minepreggo.client.model.entity.preggo.creeper.TamableHumanoidCreeperGirlP5Model;
...
@OnlyIn(Dist.CLIENT)
public class TamableHumanoidCreeperGirlP5Renderer extends AbstractTamableHumanoidPregnantCreeperGirlRenderer<TamableHumanoidCreeperGirlP5, TamableHumanoidCreeperGirlP5Model> {
	...
	public TamableHumanoidCreeperGirlP5Renderer(EntityRendererProvider.Context context, ModelLayerLocation main, ModelLayerLocation inner, ModelLayerLocation outter, ModelLayerLocation armor) {
		super(context, new TamableHumanoidCreeperGirlP5Model(context.bakeLayer(main)), new TamableHumanoidCreeperGirlP5Model(context.bakeLayer(inner)), new TamableHumanoidCreeperGirlP5Model(context.bakeLayer(outter)), new TamableHumanoidCreeperGirlP5Model(context.bakeLayer(armor)));
	}

	@Override
	public ResourceLocation getTextureLocation(TamableHumanoidCreeperGirlP5 entity) {
