...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractMonsterCreeperGirlExpressionFacialLayer 
	...
	protected AbstractMonsterCreeperGirlExpressionFacialLayer(RenderLayerParent<E, M> p_117346_) {
		super(p_117346_);
	}
