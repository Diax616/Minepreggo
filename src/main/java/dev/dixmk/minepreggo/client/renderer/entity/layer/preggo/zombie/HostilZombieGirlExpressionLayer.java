...
@OnlyIn(Dist.CLIENT)
public class HostilZombieGirlExpressionLayer 
	<E extends AbstractHostilZombieGirl, M extends AbstractHostilZombieGirlModel<E>> extends AbstractZombieGirlExpressionLayer<E, M> {
	...
	public HostilZombieGirlExpressionLayer(RenderLayerParent<E, M> p_117346_) {
		super(p_117346_);
	}
