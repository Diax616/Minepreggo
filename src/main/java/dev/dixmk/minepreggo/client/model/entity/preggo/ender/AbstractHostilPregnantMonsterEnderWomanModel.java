...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractHostilPregnantMonsterEnderWomanModel 
	<E extends AbstractHostilPregnantEnderWoman> extends AbstractHostilMonsterEnderWomanModel<E> {

	protected AbstractHostilPregnantMonsterEnderWomanModel(ModelPart root, PregnancyPhase pregnancyPhase, boolean simpleBellyJiggle, BellyInflation bellyInflation, @Nullable FetalMovementIntensity fetalMovementIntensity) {
