...
public class CustomPregnantBodyP3Model extends AbstractHeavyPregnantBodyModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "custom_pregnant_body_p3_model"), "main");
	...
	protected void animBelly(AbstractClientPlayer entity, float ageInTicks) {
		...
		if (entity.hasEffect(MinepreggoModMobEffects.FETAL_MOVEMENT.get())) {
			this.animate(this.loopAnimationState, BellyAnimation.FETAL_MOVEMENT_P3, ageInTicks);
		}
		else {
