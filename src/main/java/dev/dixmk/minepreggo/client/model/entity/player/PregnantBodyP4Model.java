...
@OnlyIn(Dist.CLIENT)
public class PregnantBodyP4Model extends AbstractHeavyPregnantBodyModel {
	
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "pregnant_body_p4_model"), "main");
	
	public PregnantBodyP4Model(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition boobs = body.addOrReplaceChild("boobs", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.5F, -1.9F, -0.3316F, 0.0F, 0.0F));
		...
		.texOffs(20, 26).addBox(-3.5F, 1.0F, -4.5F, 7.0F, 5.0F, 0.0F, new CubeDeformation(0.3F))
		.texOffs(22, 29).addBox(-0.6F, 4.1993F, -5.2305F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.0F, -2.0F, 0.0436F, 0.0F, 0.0F));
		...
		rightButt.addOrReplaceChild("rightAssCube_r1", CubeListBuilder.create().texOffs(2, 18).mirror().addBox(-1.95F, -2.0F, -1.0F, 4.0F, 4.0F, 2.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(0.05F, 1.65F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		leftButt.addOrReplaceChild("leftAssCube_r1", CubeListBuilder.create().texOffs(18, 50).mirror().addBox(-2.05F, -2.0F, -1.0F, 4.0F, 4.0F, 2.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(-0.05F, 1.65F, 0.0F, 0.0F, 3.1416F, 0.0F));
