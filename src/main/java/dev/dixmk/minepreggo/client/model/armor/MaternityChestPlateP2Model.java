...
public class MaternityChestPlateP2Model extends AbstractFemaleChestPlateModel<LivingEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(MinepreggoHelper.fromThisNamespaceAndPath("maternity_chestplate_p2_model"), "main");
