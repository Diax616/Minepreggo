...
public class PredefinedPregnantBodyP3Model extends AbstractHeavyPregnantBodyModel {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(MinepreggoHelper.fromThisNamespaceAndPath("predefined_pregnant_body_p3_model"), "main");
