...
public class MaternityChestPlateP4Model extends AbstractFemaleChestPlateModel<LivingEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(MinepreggoHelper.fromThisNamespaceAndPath("maternity_chestplate_p4_model"), "main");
