...
@OnlyIn(Dist.CLIENT)
public class PregnantBodyP1Model extends AbstractPregnantBodyModel {
	
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "pregnant_body_p1_model"), "main");
	
	public PregnantBodyP1Model(ModelPart root) {
