...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractCreeperGirlModel<E extends AbstractCreeperGirl> extends CreeperModel<E> implements HeadedModel {	
	...
	public static LayerDefinition createP3BodyLayer() {
		...
		belly.addOrReplaceChild("left_kick", CubeListBuilder.create().texOffs(6, 77).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offset(0.5F, 1.7F, -3.0F));
		...
		PartDefinition right_boob = boobs.addOrReplaceChild("right_boob", CubeListBuilder.create(), PartPose.offset(-2.25F, 0.0F, 0.0F));
		right_boob.addOrReplaceChild("Boob_1_r1", CubeListBuilder.create().texOffs(1, 65).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.4701F, 1.6687F, -0.7244F, 0.3491F, 0.1309F, 0.0436F));
		PartDefinition left_boob = boobs.addOrReplaceChild("left_boob", CubeListBuilder.create(), PartPose.offset(2.25F, 0.0F, 0.0F));
		left_boob.addOrReplaceChild("Boob_2_r1", CubeListBuilder.create().texOffs(1, 65).mirror().addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(-0.571F, 1.6643F, -0.7114F, 0.3491F, -0.1309F, -0.0436F));
		return LayerDefinition.create(meshdefinition, 64, 96);
	}
	...
	public static LayerDefinition createP4BodyLayer() {
		...
		belly.addOrReplaceChild("left_kick", CubeListBuilder.create().texOffs(7, 77).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offset(0.5F, 1.7F, -3.0F));
		...
		PartDefinition right_boob = boobs.addOrReplaceChild("right_boob", CubeListBuilder.create(), PartPose.offset(-2.25F, 0.0F, 0.0F));
		right_boob.addOrReplaceChild("Boob_1_r1", CubeListBuilder.create().texOffs(1, 65).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4701F, 1.6687F, -0.7244F, 0.3491F, 0.1309F, 0.0436F));
		PartDefinition left_boob = boobs.addOrReplaceChild("left_boob", CubeListBuilder.create(), PartPose.offset(2.25F, 0.0F, 0.0F));
		left_boob.addOrReplaceChild("Boob_2_r1", CubeListBuilder.create().texOffs(1, 65).mirror().addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.571F, 1.6643F, -0.7114F, 0.3491F, -0.1309F, -0.0436F));
		return LayerDefinition.create(meshdefinition, 64, 96);
	}
	...
	public static LayerDefinition createP5BodyLayer() {
		...
		belly.addOrReplaceChild("left_kick", CubeListBuilder.create().texOffs(8, 77).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.15F)), PartPose.offset(0.5F, 1.6128F, -4.9981F));
		...
		belly.addOrReplaceChild("front_kick", CubeListBuilder.create().texOffs(8, 77).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offset(2.0F, 2.0128F, -5.4981F));
		PartDefinition boobs = body.addOrReplaceChild("boobs", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.5F, -2.0F, -0.2967F, 0.0F, 0.0F));
		PartDefinition right_boob = boobs.addOrReplaceChild("right_boob", CubeListBuilder.create(), PartPose.offset(-2.25F, 0.0F, 0.0F));
		right_boob.addOrReplaceChild("Boob_1_r1", CubeListBuilder.create().texOffs(1, 65).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4701F, 1.6687F, -0.7244F, 0.3491F, 0.1309F, 0.0436F));
		PartDefinition left_boob = boobs.addOrReplaceChild("left_boob", CubeListBuilder.create(), PartPose.offset(2.25F, 0.0F, 0.0F));
	...
	public static LayerDefinition createP6BodyLayer() {
		...
		belly.addOrReplaceChild("front_kick", CubeListBuilder.create().texOffs(9, 79).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offset(2.5F, 3.3F, -5.5F));
		...
		belly.addOrReplaceChild("left_kick", CubeListBuilder.create().texOffs(9, 79).addBox(-1.0F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offset(-2.0F, 2.3F, -3.5F));
	...
	public static LayerDefinition createP7BodyLayer() {
		...
		belly.addOrReplaceChild("left_kick", CubeListBuilder.create().texOffs(9, 79).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offset(-1.0F, -0.1F, -6.3F));
		belly.addOrReplaceChild("right_kick", CubeListBuilder.create().texOffs(9, 79).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offset(0.0F, -0.1F, -8.3F));
		belly.addOrReplaceChild("front_kick", CubeListBuilder.create().texOffs(9, 79).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offset(2.0F, -1.1F, -7.3F));
		...
		belly.addOrReplaceChild("top_kick", CubeListBuilder.create().texOffs(9, 79).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offset(1.0F, -1.1F, -7.3F));
		PartDefinition boobs = body.addOrReplaceChild("boobs", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.5F, -2.2F, -0.3491F, 0.0F, 0.0F));
		PartDefinition right_boob = boobs.addOrReplaceChild("right_boob", CubeListBuilder.create(), PartPose.offset(-2.25F, 0.0F, 0.0F));
		right_boob.addOrReplaceChild("Boob_1_r1", CubeListBuilder.create().texOffs(1, 65).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4701F, 1.6687F, -0.7244F, 0.3491F, 0.1309F, 0.0436F));
		PartDefinition left_boob = boobs.addOrReplaceChild("left_boob", CubeListBuilder.create(), PartPose.offset(2.25F, 0.0F, 0.0F));
	...
	public static LayerDefinition createP8BodyLayer() {
		...
		belly.addOrReplaceChild("front_kick", CubeListBuilder.create().texOffs(10, 81).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offset(2.0F, -0.1F, -7.0F));
		belly.addOrReplaceChild("left_kick", CubeListBuilder.create().texOffs(10, 81).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offset(-1.0F, -0.1F, -6.0F));
		belly.addOrReplaceChild("right_kick", CubeListBuilder.create().texOffs(10, 81).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offset(0.0F, 0.9F, -8.0F));
		...
		belly.addOrReplaceChild("top_kick", CubeListBuilder.create().texOffs(10, 81).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offset(1.0F, -0.1F, -9.0F));
