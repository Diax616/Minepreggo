...
public class CustomPregnantBodyP0Model extends AbstractPregnantBodyModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		body.addOrReplaceChild("belly", CubeListBuilder.create().texOffs(20, 26).addBox(-3.0F, -0.5F, -0.95F, 6.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.0F, -1.5F));
