...
@OnlyIn(Dist.CLIENT)
public class HostilPregnantMonsterEnderWomanModel  {
	
	@OnlyIn(Dist.CLIENT)
	public static class MonsterEnderWomanP3 extends AbstractHostilPregnantMonsterEnderWomanModel<HostilPregnantMonsterEnderWoman.MonsterEnderWomanP3> {
	...
	@OnlyIn(Dist.CLIENT)
	public static class MonsterEnderWomanP5 extends AbstractHostilPregnantMonsterEnderWomanModel<HostilPregnantMonsterEnderWoman.MonsterEnderWomanP5> {
	...
	@OnlyIn(Dist.CLIENT)
	public static class MonsterEnderWomanP7 extends AbstractHostilPregnantMonsterEnderWomanModel<HostilPregnantMonsterEnderWoman.MonsterEnderWomanP7> {
