...
@OnlyIn(Dist.CLIENT)
public class SimpleJigglePhysics {
	...
	protected SimpleJigglePhysics(Builder builder) {
	...
	public static SimpleJigglePhysics.Builder simpleBuilder() {
		return new SimpleJigglePhysics.Builder();
	}
	
	public SimpleJigglePhysics copy() {
    ...
    public static class Builder {
    	...
    	public SimpleJigglePhysics build() {
    		return new SimpleJigglePhysics(this);
    	}
    }
}
