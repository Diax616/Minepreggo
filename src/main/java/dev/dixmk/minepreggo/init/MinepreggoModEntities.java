...
public class MinepreggoModEntities {
	...
	public static final RegistryObject<EntityType<MonsterZombieGirlP3>> MONSTER_ZOMBIE_GIRL_P3 = register("monster_zombie_girl_p3",
			EntityType.Builder.<MonsterZombieGirlP3>of(MonsterZombieGirlP3::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(MonsterZombieGirlP3::new).sized(0.625f, 1.8f));
	
	public static final RegistryObject<EntityType<MonsterZombieGirlP5>> MONSTER_ZOMBIE_GIRL_P5 = register("monster_zombie_girl_p5",
			EntityType.Builder.<MonsterZombieGirlP5>of(MonsterZombieGirlP5::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(MonsterZombieGirlP5::new).sized(0.725f, 1.8f));
	
	public static final RegistryObject<EntityType<MonsterZombieGirlP7>> MONSTER_ZOMBIE_GIRL_P7 = register("monster_zombie_girl_p7",
			EntityType.Builder.<MonsterZombieGirlP7>of(MonsterZombieGirlP7::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(MonsterZombieGirlP7::new).sized(0.8f, 1.8f));
	...
	public static final RegistryObject<EntityType<TamableZombieGirlP4>> TAMABLE_ZOMBIE_GIRL_P4 = register("tamable_zombie_girl_p4",
			EntityType.Builder.<TamableZombieGirlP4>of(TamableZombieGirlP4::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableZombieGirlP4::new).sized(0.65f, 1.8f));
	
	public static final RegistryObject<EntityType<TamableZombieGirlP5>> TAMABLE_ZOMBIE_GIRL_P5 = register("tamable_zombie_girl_p5",
			EntityType.Builder.<TamableZombieGirlP5>of(TamableZombieGirlP5::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableZombieGirlP5::new).sized(0.675f, 1.8f));
	
	public static final RegistryObject<EntityType<TamableZombieGirlP6>> TAMABLE_ZOMBIE_GIRL_P6 = register("tamable_zombie_girl_p6",
			EntityType.Builder.<TamableZombieGirlP6>of(TamableZombieGirlP6::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableZombieGirlP6::new).sized(0.7f, 1.8f));
	
	public static final RegistryObject<EntityType<TamableZombieGirlP7>> TAMABLE_ZOMBIE_GIRL_P7 = register("tamable_zombie_girl_p7",
			EntityType.Builder.<TamableZombieGirlP7>of(TamableZombieGirlP7::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableZombieGirlP7::new).sized(0.75f, 1.8f));
	
	public static final RegistryObject<EntityType<TamableZombieGirlP8>> TAMABLE_ZOMBIE_GIRL_P8 = register("tamable_zombie_girl_p8",
			EntityType.Builder.<TamableZombieGirlP8>of(TamableZombieGirlP8::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableZombieGirlP8::new).sized(0.8f, 1.8f));
	...
	public static final RegistryObject<EntityType<MonsterHumanoidCreeperGirlP3>> MONSTER_HUMANOID_CREEPER_GIRL_P3 = register("monster_humanoid_creeper_girl_p3",
			EntityType.Builder.<MonsterHumanoidCreeperGirlP3>of(MonsterHumanoidCreeperGirlP3::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(MonsterHumanoidCreeperGirlP3::new).sized(0.625f, 1.8f));
	...
	public static final RegistryObject<EntityType<MonsterHumanoidCreeperGirlP5>> MONSTER_HUMANOID_CREEPER_GIRL_P5 = register("monster_humanoid_creeper_girl_p5",
			EntityType.Builder.<MonsterHumanoidCreeperGirlP5>of(MonsterHumanoidCreeperGirlP5::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(MonsterHumanoidCreeperGirlP5::new).sized(0.7f, 1.8f));
	...
	public static final RegistryObject<EntityType<MonsterHumanoidCreeperGirlP7>> MONSTER_HUMANOID_CREEPER_GIRL_P7 = register("monster_humanoid_creeper_girl_p7",
			EntityType.Builder.<MonsterHumanoidCreeperGirlP7>of(MonsterHumanoidCreeperGirlP7::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(MonsterHumanoidCreeperGirlP7::new).sized(0.775f, 1.8f));
	...
	public static final RegistryObject<EntityType<TamableHumanoidCreeperGirlP2>> TAMABLE_HUMANOID_CREEPER_GIRL_P2 = register("tamable_humanoid_creeper_girl_p2",
			EntityType.Builder.<TamableHumanoidCreeperGirlP2>of(TamableHumanoidCreeperGirlP2::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableHumanoidCreeperGirlP2::new).sized(0.6f, 1.8f));
	...
	public static final RegistryObject<EntityType<TamableHumanoidCreeperGirlP3>> TAMABLE_HUMANOID_CREEPER_GIRL_P3 = register("tamable_humanoid_creeper_girl_p3",
			EntityType.Builder.<TamableHumanoidCreeperGirlP3>of(TamableHumanoidCreeperGirlP3::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableHumanoidCreeperGirlP3::new).sized(0.6f, 1.8f));
	...
	public static final RegistryObject<EntityType<TamableHumanoidCreeperGirlP4>> TAMABLE_HUMANOID_CREEPER_GIRL_P4 = register("tamable_humanoid_creeper_girl_p4",
			EntityType.Builder.<TamableHumanoidCreeperGirlP4>of(TamableHumanoidCreeperGirlP4::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableHumanoidCreeperGirlP4::new).sized(0.65f, 1.8f));
	...
	public static final RegistryObject<EntityType<TamableHumanoidCreeperGirlP5>> TAMABLE_HUMANOID_CREEPER_GIRL_P5 = register("tamable_humanoid_creeper_girl_p5",
			EntityType.Builder.<TamableHumanoidCreeperGirlP5>of(TamableHumanoidCreeperGirlP5::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableHumanoidCreeperGirlP5::new).sized(0.7f, 1.8f));
	...
	public static final RegistryObject<EntityType<TamableHumanoidCreeperGirlP6>> TAMABLE_HUMANOID_CREEPER_GIRL_P6 = register("tamable_humanoid_creeper_girl_p6",
			EntityType.Builder.<TamableHumanoidCreeperGirlP6>of(TamableHumanoidCreeperGirlP6::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableHumanoidCreeperGirlP6::new).sized(0.725f, 1.8f));
	...
	public static final RegistryObject<EntityType<TamableHumanoidCreeperGirlP7>> TAMABLE_HUMANOID_CREEPER_GIRL_P7 = register("tamable_humanoid_creeper_girl_p7",
			EntityType.Builder.<TamableHumanoidCreeperGirlP7>of(TamableHumanoidCreeperGirlP7::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableHumanoidCreeperGirlP7::new).sized(0.775f, 1.8f));
	...
	public static final RegistryObject<EntityType<TamableHumanoidCreeperGirlP8>> TAMABLE_HUMANOID_CREEPER_GIRL_P8 = register("tamable_humanoid_creeper_girl_p8",
			EntityType.Builder.<TamableHumanoidCreeperGirlP8>of(TamableHumanoidCreeperGirlP8::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(TamableHumanoidCreeperGirlP8::new).sized(0.8f, 1.8f));
