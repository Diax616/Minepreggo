...
public class MinepreggoModItems {
	...
	public static final RegistryObject<Item> TAMABLE_HUMANOID_CREEPER_GIRL_P1_SPAWN_EGG = REGISTRY.register("tamable_humanoid_creeper_girl_p1_spawn_egg", () -> new ForgeSpawnEggItem(MinepreggoModEntities.TAMABLE_HUMANOID_CREEPER_GIRL_P1, -16738048, -26368, new Item.Properties()));
	public static final RegistryObject<Item> TAMABLE_HUMANOID_CREEPER_GIRL_P2_SPAWN_EGG = REGISTRY.register("tamable_humanoid_creeper_girl_p2_spawn_egg", () -> new ForgeSpawnEggItem(MinepreggoModEntities.TAMABLE_HUMANOID_CREEPER_GIRL_P2, -16738048, -26368, new Item.Properties()));
	public static final RegistryObject<Item> TAMABLE_HUMANOID_CREEPER_GIRL_P3_SPAWN_EGG = REGISTRY.register("tamable_humanoid_creeper_girl_p3_spawn_egg", () -> new ForgeSpawnEggItem(MinepreggoModEntities.TAMABLE_HUMANOID_CREEPER_GIRL_P3, -16738048, -26368, new Item.Properties()));
	public static final RegistryObject<Item> TAMABLE_HUMANOID_CREEPER_GIRL_P4_SPAWN_EGG = REGISTRY.register("tamable_humanoid_creeper_girl_p4_spawn_egg", () -> new ForgeSpawnEggItem(MinepreggoModEntities.TAMABLE_HUMANOID_CREEPER_GIRL_P4, -16738048, -26368, new Item.Properties()));
	public static final RegistryObject<Item> TAMABLE_HUMANOID_CREEPER_GIRL_P5_SPAWN_EGG = REGISTRY.register("tamable_humanoid_creeper_girl_p5_spawn_egg", () -> new ForgeSpawnEggItem(MinepreggoModEntities.TAMABLE_HUMANOID_CREEPER_GIRL_P5, -16738048, -26368, new Item.Properties()));
	public static final RegistryObject<Item> TAMABLE_HUMANOID_CREEPER_GIRL_P6_SPAWN_EGG = REGISTRY.register("tamable_humanoid_creeper_girl_p6_spawn_egg", () -> new ForgeSpawnEggItem(MinepreggoModEntities.TAMABLE_HUMANOID_CREEPER_GIRL_P6, -16738048, -26368, new Item.Properties()));
