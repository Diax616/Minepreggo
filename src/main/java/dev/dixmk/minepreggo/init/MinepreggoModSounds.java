...
public class MinepreggoModSounds {
	...
	public static final RegistryObject<SoundEvent> STOMACH_GROWLS_1 = REGISTRY.register("stomach_growls_1", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "stomach_growls_1")));
	public static final RegistryObject<SoundEvent> STOMACH_GROWLS_2 = REGISTRY.register("stomach_growls_2", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "stomach_growls_2")));
	public static final RegistryObject<SoundEvent> STOMACH_GROWLS_3 = REGISTRY.register("stomach_growls_3", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "stomach_growls_3")));
	public static final RegistryObject<SoundEvent> STOMACH_GROWLS_4 = REGISTRY.register("stomach_growls_4", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "stomach_growls_4")));
	public static final RegistryObject<SoundEvent> STOMACH_GROWLS_5 = REGISTRY.register("stomach_growls_5", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "stomach_growls_5")));
	public static final RegistryObject<SoundEvent> STOMACH_GROWLS_6 = REGISTRY.register("stomach_growls_6", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "stomach_growls_6")));

	public static final RegistryObject<SoundEvent> PLAYER_PUSH_1 = REGISTRY.register("player_push_1", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "player_push_1")));
	public static final RegistryObject<SoundEvent> PLAYER_PUSH_2 = REGISTRY.register("player_push_2", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "player_push_2")));
	public static final RegistryObject<SoundEvent> PLAYER_PUSH_3 = REGISTRY.register("player_push_3", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(MinepreggoMod.MODID, "player_push_3")));
