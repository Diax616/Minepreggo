...
public class MinepreggoVillagerProfessions {
	
	private MinepreggoVillagerProfessions() {}
	...
	public static final RegistryObject<VillagerProfession> VILLAGER_DOCTOR = registerProfession("doctor", MinepreggoBlocks.MEDICAL_TABLE::get,
