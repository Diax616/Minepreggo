...
public class MinepreggoSounds {
	
	private MinepreggoSounds() {}
	...
	public static final RegistryObject<SoundEvent> PLAYER_BIRTH_1 = REGISTRY.register("player_birth_1", () -> SoundEvent.createVariableRangeEvent(MinepreggoHelper.fromThisNamespaceAndPath("player_birth_1")));
	public static final RegistryObject<SoundEvent> PLAYER_BIRTH_2 = REGISTRY.register("player_birth_2", () -> SoundEvent.createVariableRangeEvent(MinepreggoHelper.fromThisNamespaceAndPath("player_birth_2")));
	...
	public static final RegistryObject<SoundEvent> SPLASH = REGISTRY.register("splash", () -> SoundEvent.createVariableRangeEvent(MinepreggoHelper.fromThisNamespaceAndPath("splash")));
	...
	public static final SoundEvent getRandomPlayerBirth(RandomSource random) {
		return switch (random.nextInt(2)) {
			case 0 -> PLAYER_BIRTH_1.get();
			default -> PLAYER_BIRTH_2.get();
		};
	}
}